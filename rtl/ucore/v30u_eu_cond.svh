//============================================================================
//  ALLINEATO A MONTE 2026-08-21: nec_test c59d2054 "Fix REP termination
//  before interrupt withdrawal" (Martin Donlon / wickerwaka).
//
//  Sostituisce la nostra patch locale del 2026-08-18, che risolveva LO STESSO
//  difetto con una struttura diversa (catena di else-if invece del test di
//  `taken`): verificato che erano BEHAVIORALMENTE EQUIVALENTI e che il resto
//  del file era gia' identico riga per riga.
//  Il difetto: un INT pendente sull'iterazione che TROVA il match (REPNE SCASB
//  sul terminatore) ritirava la REP con DI/CX gia' avanzati e il match mai
//  consultato -> al rientro la scansione riprendeva OLTRE il terminatore.
//  Sintomo misurato su Raiden II: strlen del punteggio tornava 12 invece di 6.
//  Nostra analisi: docs/BUG_REP_SCASB_INT_2026-08-18.md
//============================================================================
//============================================================================
